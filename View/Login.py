...
gradient = generate_gradient_color(start_color3, end_color3, 500, 500)
...
button1 = CTkButton(master=frame1, width=220, text="Register",anchor="center",command=lambda: validate_form(app, entry1, entry2))
