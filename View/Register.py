...
image = Image.open("C:/Users/PAMSTORE/Pictures/Saved Pictures/wallet.jpg")
...
entry3 = customtkinter.CTkEntry(master=frame3, width=280, placeholder_text="Password", bg_color="#C9C4C4")
...
entry4 = customtkinter.CTkEntry(master=frame3, width=280, placeholder_text="Confirm password", bg_color="#C9C4C4")
